...
export const initialMembers: Member[] = [
  ...
  // { id: "u4", name: "Priya Nair", handle: "@priyan", role: "member", online: true },
  // { id: "u5", name: "Sam O'Neill", handle: "@samo", role: "member", online: false },
  // { id: "u6", name: "Yuki Tanaka", handle: "@yukit", role: "member", online: true },
  // { id: "u7", name: "Noah Bergström", handle: "@noahb", role: "member", online: false },
...
export const allContacts: Contact[] = [
  ...
  // { id: "c4", name: "Fatima Haidari", handle: "@fatimah" },
  // { id: "c5", name: "Theo Brandt", handle: "@theob" },
];
